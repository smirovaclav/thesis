...
* The full text of the thesis is available as a PDF in **`[INSERT_FILE_NAME.pdf]`** (or in the Releases section).
* **Author:** Václav Šmíro
...
---
*To run the code, we recommend using a Python environment with the packages listed in `requirements.txt`.*
